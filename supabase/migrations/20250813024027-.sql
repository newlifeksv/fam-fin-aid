-- Fixing policies: drop if exists then create
...
CREATE POLICY "Family visible to members"
ON public.families
FOR SELECT
TO authenticated
...
CREATE POLICY "Users can remove themselves from a family"
ON public.family_members
FOR DELETE
TO authenticated
...
CREATE POLICY "Inviter or invited user can view invite"
ON public.invites
FOR SELECT
TO authenticated
USING (
